...
const EditReview = ({ reviewData, setShowReviewModal, showReviewModal }) => {
  ...
  return (
    <form id="edit_review_form" onSubmit={onSubmit}>
      <div id="edit_review_text">
        <h1>
      ...
      <div id="edit_review_errors">
        {ErrorHandler}
      </div>
      <div className="edit_review_input_containers">
        <div className="edit_review_form_input_box">
          <label>Review's Text:</label>
          <div className="edit_review_form_input_count">
            <input
              name='Review Text'
              type='text'
              ...
              />
              {reviewTextCharCount > 0 && (<div className="edit_review_character_count">Remaining Characters: {reviewTextCharCount}/2000</div>)}
          </div>
        </div>
        <div className="edit_review_form_input_box">
          <label>Rating: </label>
      ...
      <div className='edit_review_form_footer'>
        <button className='edit_review_cancel_button' onClick={cancelSubmit}>Cancel</button>
        <button className='edit_review_submit_button' type="submit" disabled={disableSubmit} hidden={disableSubmit}>Confirm</button>
      </div>
